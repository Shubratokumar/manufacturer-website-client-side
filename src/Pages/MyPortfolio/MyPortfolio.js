  ...
  return (
    <div className="px-20 bg-blue-50">
      ...
      <section>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-10 justify-items-center content-center py-10">
          <div className="card w-full bg-base-100 shadow-xl p-10">
              <h2 className="text-2xl uppercase text-secondary text-center">Technical Skills</h2>
            ...
            <div>
                ...
                <div>
                    ...
                    <progress class="progress progress-success w-full" value="73" max="100"></progress>
                </div>
                <div>
                    <div className="flex justify-between font-bold ">
                        <div>MongoDB</div>
          ...
          <div className="card w-full bg-base-100 shadow-xl p-10">
              <h2 className="text-2xl uppercase text-secondary text-center">Professional Skills</h2>
              <div class="flex mt-6 justify-center mb-4">
                <div class="w-60 h-1 rounded-full bg-primary inline-flex"></div>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-5 justify-items-center content-center text-secondary">
                ...
                <div className="card-body items-center text-center">
                  <div class="radial-progress text-secondary" style={{"--value":90}}>90%</div>
                ...
                <div className="card-body items-center text-center">
                  <div class="radial-progress text-secondary" style={{"--value":75}}>75%</div>
      ...
      <section>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-10 justify-items-center content-center py-10">
          <div className="card w-full bg-base-100 shadow-xl p-10">
              <h2 className="text-2xl uppercase text-secondary pb-3 ">Education</h2>
                <div class="w-60 h-1 rounded-full bg-primary inline-flex"></div>
            <div>
                <div className="mt-3">
          ...
          <div className="card w-full bg-base-100 shadow-xl p-10">
                <h2 className="text-2xl uppercase text-secondary pb-3 ">Some of my Project</h2>
                <div class="w-60 h-1 rounded-full bg-primary inline-flex"></div>
                <div>
                <div className="mt-3">
                    ...
                    <p>Live Link : <a className="link link-secondary"  href=" https://service-provider-with-firebase.web.app/" target="_blank">https://service-provider-with-firebase.web.app/</a> </p>
                ...
                <div className="mt-3">
                    ...
                    <p>Live Link : <a className="link link-secondary"  href=" https://laptop-check-with-react-router.netlify.app/" target="_blank">https://laptop-check-with-react-router.netlify.app/</a></p>
                </div>
                <div className="mt-3">
                    <p className="text-xl py-2">Project - 03</p>
                    <hr />
                    <p>Project Name: Smart Watch Shop </p>
                    <p>Live Link : <a className="link link-secondary"  href=" https://smart-watch-shop-react-app.netlify.app/" target="_blank"> https://smart-watch-shop-react-app.netlify.app/</a></p>
                </div>
            </div>
          </div>
        </div>
